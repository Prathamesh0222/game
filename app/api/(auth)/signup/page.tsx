    ...
    <div>
      ...
      <div className="bg-black w-[160%] md:w-full lg:w-[50%] md:pb-32 pb-[6rem] lg:pb-0">
        <div className="pt-36 lg:pt-20">
          <p className="font-semibold text-[32px] text-center text-white">
            Register{" "}
          </p>
          <p className="font-normal text-[20px] text-white text-center pt-[15px]">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-[18px] pt-14 mx-16 md:mx-0">
            <button
              type="button"
              className="flex px-[16px] md:px-[50px] lg:px-[60px] py-3 bg-black text-white font-semibold text-center outline outline-slate-300 outline-1 text-[18px] rounded-lg"
            >
              <Image
                alt="google"
                src={google}
          ...
          <div className="flex flex-col gap-6 pt-4 px-16 md:px-44 lg:px-52">
            <div>
              ...
              <input
                type="text"
                id="first_name"
                className="bg-[#232323] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
            ...
            <div className="pt-3">
              <button
                type="button"
                className="pl-[140px] pr-[150px] md:pl-[190px] md:pr-[177px] lg:pl-[190px] lg:pr-[200px] py-3 bg-white text-black font-semibold text-center text-sm rounded-lg"
              >
                Submit
              </button>
            </div>
          ...
          <div className="pt-[25px]">
            <p className="font-normal text-white text-[18px] text-center">
              Already have an account?{" "}
              <span>
                <a
                  className="font-semibold"
                  href="https://localhost.com/signin"
                >
                  Signin
                </a>
              </span>
