  ...
  return (
    <main className="grid lg:grid-cols-2 h-screen">
      <div className="flex flex-col justify-center items-center">
        ...
        <p className="text-xl mt-2">Enter your credentials to signin</p>
        <div className="flex gap-4 mt-8">
          <button className="flex justify-center items-center gap-2 rounded-xl font-semibold border border-white/35 p-2.5 w-[198px] hover:bg-neutral-900/80">
        ...
        <div className="w-[396px] flex items-center mt-8">
        ...
        <div className="flex flex-col justify-center mt-4">
          ...
          <input
            ...
            className="rounded-lg p-4 w-[396px] h-11 bg-[#232323]"
          />
          ...
          <input
            ...
            className="rounded-lg p-4 w-[396px] h-11 bg-[#232323]"
          />
          <button className="bg-white text-black p-2 rounded-lg font-semibold h-11 mt-8">
            Submit
          </button>
          <span className="flex justify-center mt-5 gap-1 text-center">
